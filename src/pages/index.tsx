    ...
    <Layout>
      ...
      <section className="container mx-auto py-8">
        ...
        <p className="text-right mt-8">
          ปัจจุบันค่าเฟ่ และห้องสมุดของเรา อยู่ในช่วงการดูแลของ นายพงศกร นพรัตยาภรณ์ 65070142 
          ซึ่งมีบริการ สั่งเครื่องดืมในระบบของเว็บไซต์ สามารถสั่งได้เลยโดยไม่จำเป็นต้องเข้าไปนั่ง
        </p>
      </section>
